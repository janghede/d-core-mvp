...
!(function (t, e) {
        ...
        ? (function (t, e, i) {
            return function n(s) {
              ...
              for (let { target: r } = s; r && r !== this; r = r.parentNode)
                for (const a of o) if (a === r) return j(s, { delegateTarget: r }), n.oneOff && P.off(t, s.type, e, i), i.apply(r, [s]);
            };
          })(t, i, r)
        : (function (t, e) {
            return function i(n) {
    ...
    _addEventListeners() {
      this._config.keyboard && P.on(this._element, "keydown.bs.carousel", (t) => this._keydown(t)),
        "hover" === this._config.pause &&
          (P.on(this._element, "mouseenter.bs.carousel", () => this.pause()), P.on(this._element, "mouseleave.bs.carousel", () => this._maybeEnableCycle())),
  ...
  function ne(t) {
    ...
    return i && ("html" === Wt(i) || ("body" === Wt(i) && "static" === Jt(i).position))
      ? e
      : i ||
          (function (t) {
  ...
  function de(t) {
    ...
    if (c) {
      var A = ne(i),
        E = "clientHeight",
        T = "clientWidth";
      A === Bt(i) && "static" !== Jt((A = te(i))).position && "absolute" === a && ((E = "scrollHeight"), (T = "scrollWidth")),
        (s === gt || ((s === bt || s === _t) && o === At)) &&
          ((y = mt), (g -= (d && A === w && w.visualViewport ? w.visualViewport.height : A[E]) - n.height), (g *= l ? 1 : -1)),
        (s !== bt && ((s !== gt && s !== mt) || o !== At)) ||
          ((v = _t), (f -= (d && A === w && w.visualViewport ? w.visualViewport.width : A[T]) - n.width), (f *= l ? 1 : -1));
    }
    var C,
        ...
        for (
          var s = i.mainAxis,
            ...
            v = [m].concat(b).reduce(function (t, i) {
              return t.concat(
                Vt(i) === vt ? ke(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: g }) : i
              );
            }, []),
            y = e.rects.reference,
            w = e.rects.popper,
  ...
  function Me(t, e, i) {
    ...
    return (
      (o || (!o && !i)) &&
        (("body" !== Wt(e) || we(a)) && (c = (n = e) !== Bt(n) && zt(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : ve(n)),
        zt(e) ? (((h = Yt(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = ye(a))),
        ...
        h = {
          ...
          setOptions: function (i) {
            ...
            d(),
              ...
              (a.scrollParents = { reference: Ft(t) ? Ee(t) : t.contextElement ? Ee(t.contextElement) : [], popper: Ee(e) });
            var r,
              c,
              u = (function (t) {
                var e = He(t);
          ...
          forceUpdate: function () {
            if (!c) {
              var t = a.elements,
                ...
                i = t.popper;
              if (We(e, i)) {
                (a.rects = { reference: Me(e, ne(i), "fixed" === a.options.strategy), popper: Ut(i) }),
                  (a.reset = !1),
    ...
    _getTemplateFactory(t) {
      return (
        this._templateFactory
          ...
          : (this._templateFactory = new Yi({ ...this._config, content: t, extraClass: this._resolvePossibleFunction(this._config.customClass) })),
        this._templateFactory
      );
    }
  ...
  class mn extends z {
    ...
    _activateParents(t) {
      if (t.classList.contains("dropdown-item")) Q.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(un);
        ...
        for (const e of Q.parents(t, ".nav, .list-group")) for (const t of Q.prev(e, ".nav-link, .nav-item > .nav-link, .list-group-item")) t.classList.add(un);
    }
    _clearActiveClass(t) {
